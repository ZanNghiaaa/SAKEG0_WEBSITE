    ...
    <main>
      ...
      <section className="team-stories-section">
        <div className="container">
          ...
          <div className="team-stories-grid">
            {teamStories.map((member) => (
              <article className="team-story-card" key={member.name}>
                <div className="team-story-top">
                  <div className="team-story-photo-wrap">
                    <div className="team-story-photo-ring"></div>
                    <img
                      src={member.image}
                      alt={member.name}
                      className="team-story-photo"
                    />
                    <div className="team-story-avatar">
                ...
                <div className="team-story-quote-icon">

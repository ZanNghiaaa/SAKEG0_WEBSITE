...
// Register new user via local-first registry
...
// Register new user (old - localStorage)
...
// Login user via local-first registry
export const loginUser = async (emailOrUsername, password) => {
  try {
    const user = loginUserLocal(emailOrUsername, password);
    // Lưu mock token vào localStorage để các trang kiểm tra tính đăng nhập
...
// Login user (old - for backward compatibility)
export const loginUserLocal = (emailOrUsername, password) => {
